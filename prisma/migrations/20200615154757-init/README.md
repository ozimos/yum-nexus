# Migration `20200615154757-init`

This migration has been generated by Tovieye Moses Ozi at 6/15/2020, 3:47:57 PM.
...
"addressId" text   ,"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"status" "Status" NOT NULL DEFAULT 'PENDING',"updatedAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"userId" text  NOT NULL ,
    PRIMARY KEY ("id"))
