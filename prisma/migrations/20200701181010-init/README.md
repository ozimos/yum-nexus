# Migration `20200701181010-init`

This migration has been generated by Tovieye Ozi at 7/1/2020, 6:10:10 PM.
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"menuDate" timestamp(3)  NOT NULL ,"tags" text []  ,"updatedAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"userId" text  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "yum_diner"."DefaultMenu" (
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" text  NOT NULL ,"menuId" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"userId" text  NOT NULL ,
    PRIMARY KEY ("id"))

CREATE TABLE "yum_diner"."SavedMenus" (
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"menuId" text  NOT NULL ,"userId" text  NOT NULL ,
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"email" text  NOT NULL ,"facebookId" text   ,"firstName" text   ,"googleId" text   ,"id" text  NOT NULL ,"lastName" text   ,"password" text   ,"picture" jsonb   ,"roles" "Role"[]  ,"tokenVersion" text  NOT NULL ,"updatedAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"))
...
CREATE UNIQUE INDEX "menuMine" ON "yum_diner"."Menu"("id","userId")

CREATE UNIQUE INDEX "menuDateMine" ON "yum_diner"."Menu"("menuDate","userId")

CREATE UNIQUE INDEX "DefaultMenu.userId" ON "yum_diner"."DefaultMenu"("userId")

CREATE UNIQUE INDEX "DefaultMenu_menuId_userId" ON "yum_diner"."DefaultMenu"("menuId","userId")
...
ALTER TABLE "yum_diner"."DefaultMenu" ADD FOREIGN KEY ("menuId", "userId")REFERENCES "yum_diner"."Menu"("id","userId") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "yum_diner"."DefaultMenu" ADD FOREIGN KEY ("userId")REFERENCES "yum_diner"."User"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "yum_diner"."SavedMenus" ADD FOREIGN KEY ("menuId")REFERENCES "yum_diner"."Menu"("id") ON DELETE CASCADE  ON UPDATE CASCADE

ALTER TABLE "yum_diner"."SavedMenus" ADD FOREIGN KEY ("userId")REFERENCES "yum_diner"."User"("id") ON DELETE CASCADE  ON UPDATE CASCADE
